...
Public Class Form1
  ...
  Private _appCuKey As RegistryKey
  ...
  Private Sub btnUnzip_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUnzip.Click
    ...
    If Not String.IsNullOrEmpty(tbZipToOpen.Text) And
  ...
  Public ReadOnly Property AppCuKey() As RegistryKey
    Get
      If (_appCuKey Is Nothing) Then
        Me._appCuKey = Registry.CurrentUser.OpenSubKey(AppRegyPath, True)
        If (Me._appCuKey Is Nothing) Then
          Me._appCuKey = Registry.CurrentUser.CreateSubKey(AppRegyPath)
        End If
      End If
      Return _appCuKey
    End Get
